...
if (isset($_POST['submitted'])) {
    ...
    if ($isvalid) {
        ...
        $insertPersonalInfo = new clsUserInfo();

        $retVal = $insertPersonalInfo->InsertPersonalInfo($userId, $name, $fatherName, $motherName, $presentAddress, $permanentAddress, $gender, $maritalStatus, $religion, $bloodGroup, $cell, $careerObj, $ref1, $ref2);
...
<?php echo $ref2Err; ?>
                ...
                <div class="row">
                    ...
                    <div class="rightCol row2">                    
                        <input type="submit" id="btnCVCommon" name="submitted" title="Save & Continue" value="Save & Continue" /> 
                    </div>
                </div>
            </div>
        </form>
